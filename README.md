...
Contents may also be tested by locally by cloning the contents of this repository and serving `index.html` in the root of the repository file structure. This project is implemented as a single page, switching contents via Javascript. No additional `.html` files are provided or required.
